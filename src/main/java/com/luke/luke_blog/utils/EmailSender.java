...
public class EmailSender {
    ...
    private final String code = "ZVGSIIGXBMWDSPKI";

    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_163(false), "lukelongdad@163.com", "ZVGSIIGXBMWDSPKI");
    }
    ...
    public static void sendRegisterVerifyCode(String code,String emailAddress) throws Exception{
        EmailSender.subject("Luke博客系统注册验证码")
                .from("Luke博客系统")
                .text("您的验证码是: "+code+" ,请在收到邮件1分钟内使用")
                .to(emailAddress)
                .send();
    }
}
